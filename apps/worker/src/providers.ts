...
export function openAiReasoning(reasoning: ReasoningLevel) {
...
function anthropicThinkingBudget(reasoning: ReasoningLevel) {
  switch (reasoning) {
    case "minimal":
      return 1_024;
    case "low":
...
function accountIdFromJwt(credential: OAuthCredential) {
  try {
