...
export function workspaceLayer(projectPath: string): Layer.Layer<Workspace> {
...
function lexicalPathInside(root: string, inputPath: string): string {
...
function workspaceError(
  ...
  path: string,
): (error: unknown) => WorkspaceToolError {
  return (error) =>
